...
def configure_tty():
    ...
    By putting the terminal in non-blocking mode, turning off echo, and
    turning off canonical line interpretation, it becomes easy to run
    ``stdin.read()`` to see each keystroke the user types.
